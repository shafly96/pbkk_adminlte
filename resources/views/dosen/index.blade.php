...
<table class="table table-bordered table-striped table-hover table-condensed tfix">
 ...
 <td><b>Anak Wali</b></td> <td colspan="2"><b>MENU</b></td>
 </tr></thead>
@foreach($dsn as $m)
 <tr><td>{{ $m->nip }}</td><td>{{ $m->namadosen }}</td>
 <td align="center" width="30px">
 <a href="{{url('')}}/dosen/listMhsWali/{{$m->nip}}" class="btn btn-success btn-sm" 
    role="button"><i class="fa fa-pencil-square"></i> Detil Anak Wali</a></td>
 <td align="center" width="30px">
 <a href="{{url('')}}/dosen/{{$m->nip}}/edit" class="btn btn-warning btn-sm" 
